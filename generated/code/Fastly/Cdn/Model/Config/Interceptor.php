...
class Interceptor extends \Fastly\Cdn\Model\Config implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canPublishDebugBacktrace');
        if (!$pluginInfo) {
            return parent::canPublishDebugBacktrace();
        } else {
            return $this->___callPlugins('canPublishDebugBacktrace', func_get_args(), $pluginInfo);
        }
    }
